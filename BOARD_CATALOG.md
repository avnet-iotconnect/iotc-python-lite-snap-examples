# Board & Supplier Catalog

This catalog lists validated or in-progress example platforms supported by the `iotconnect` Snap.

Each row corresponds to a board folder under `boards/` in this repository.

## Catalog

| Supplier           | Model                         | Arch  | Processor                                             | AI acceleration                                   | Example folder                                      |
|--------------------|-------------------------------|-------|-------------------------------------------------------|---------------------------------------------------|-----------------------------------------------------|
...
| Microchip          | Curiosity PIC64GX1000 Kit     | riscv64 | PIC64GX1000 (quad-core 64-bit RISC-V)              | —                                                 | [boards/microchip/CURIOSITY-PIC64GX1000-KIT](boards/microchip/CURIOSITY-PIC64GX1000-KIT) |
