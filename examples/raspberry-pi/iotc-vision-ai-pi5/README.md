...
From the repo root:
```bash
cd ~/iotc-python-lite-snap-examples/examples/raspberry-pi/iotc-vision-ai-pi5
...
## 12) References (links reused from Avnet repos/resources)
...
## Raspberry Pi 5 Setup Links (public)
