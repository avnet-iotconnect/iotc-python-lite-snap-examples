...
> **References**
> - Demos repo (structure and examples): https://github.com/avnet-iotconnect/iotc-python-lite-sdk-demos
...
```bash
sudo apt update
sudo apt install -y python3-full python3-venv git curl v4l-utils ffmpeg libgtk-3-0t64 libgl1
```
...
## 5. Clone this repo (recommended)

```bash
git clone https://github.com/avnet-iotconnect/iotc-python-lite-snap-examples.git
cd iotc-python-lite-snap-examples/examples/raspberry-pi
```

If you already have a local copy of this repo, just `cd` into it.

---

## 6. Create a workspace and Python env
...
**[`iotc-vision-ai-pi5/`](iotc-vision-ai-pi5/)**

To install its Python dependencies:
```bash
pip install -r iotc-vision-ai-pi5/src/requirements.txt
```
