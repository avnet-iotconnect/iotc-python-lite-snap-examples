...
This README consolidates the Smart Asset Monitoring feature set, KPI authoring patterns, sensor wiring and mapping, dashboards, rules, and worked examples into one cohesive reference for teams building KPI-driven solutions on IOTCONNECT.
